...
<div id="_o5DlQLFzRjy6LR5afRNpRg">

<div id="_t0ZeYNKHQRike0BCx9qbJw">

Cogito ergo sum

</div>

<script id="_EzQlPe8ARKGQBlm_nf0sXQ">if (window.htmx) htmx.process(document.body)</script>
...
<div id="_Yce1SadjQ0KcXgP_WjNKHg">

<p hx-get="/hoho" hx-trigger="load" id="_eln79B5LQ8_luhCKfT7W-w">
not loaded
</p>
<script id="_InGAXNY3SyWjQWuBvq8U7Q">if (window.htmx) htmx.process(document.body)</script>
...
<div id="_a91foBV-TLiJh9NEsI6lMg">

<div id="_i2cgl25ETJ6DpjGSVSS5nA">

</div>

<script id="_O7wEcWcDRK_YGIZCrOMrSA">if (window.htmx) htmx.process(document.body)</script>
...
<div id="_Hr4knVu-TgudqumTUT_LFw">

<p hx-get="/foo" hx-trigger="load" hx-target="#_i2cgl25ETJ6DpjGSVSS5nA" id="_dEiTFQQ9SLusFCblEPeKIg">
hi
</p>
<script id="__JEBCBScRhKP5cnlpzOlrg">if (window.htmx) htmx.process(document.body)</script>
